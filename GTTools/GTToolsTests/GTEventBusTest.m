...
- (void)handleEventMessage:(GTEventMessage *)eventMessage completion:(GTCallBackBlock)completion {
    NSLog(@"---->%@--->%i----->%@",eventMessage.name,eventMessage.messageType,eventMessage.messageBody);
    completion(@"我已经收到消息了");
}
+ (void)handleEventMessage:(GTEventMessage *)eventMessage completion:(GTCallBackBlock)completion {
    NSLog(@"--class-->%@--->%i----->%@",eventMessage.name,eventMessage.messageType,eventMessage.messageBody);
    completion(@"我已经收到消息了");
}
@end
